...
const initialPosts: Post[] = [
  ...
  },
  {
    id: "4",
    type: "reel",
    username: "EduHub_Official",
    time: "1 hour ago",
    tag: "Learn",
    content: "🧠 Quick Physics Tip: Understanding Newton's Laws in 60 seconds! #education #physics #studytips",
    likes: 1200,
    comments: [],
    shares: 89,
  ...
  },
  {
    id: "5",
    type: "reel",
    username: "Quiz_Masters",
    time: "3 hours ago",
    tag: "Quiz",
    content: "🎯 Daily Quiz Challenge: Can you solve this math puzzle? Comment your answer! #quiz #braingames",
    likes: 5600,
    comments: [],
    shares: 234,
  ...
  },
  {
    id: "6",
    type: "reel",
    username: "Code_Competition",
    time: "5 hours ago",
    tag: "Competition",
    content: "🏆 Hackathon 2024 Highlights! Watch the winning team's presentation #coding #hackathon #competition",
    likes: 890,
    comments: [],
    shares: 45,
